export const AdminUsersPanel = ({
  ...
  return (
    <section className="panel panel--form panel--categories panel--users">
      ...
      <div className="users-manage-grid">
        {isRootAdmin && (
          <div className="users-manage-card">
                ...
                <div className="checkbox-list">
                  <label className="checkbox-item">
                    <input
                      ...
                      disabled={createUserSaving}
                    />
                    <span>Pode aprovar e solicitar revisao</span>
                  </label>
                </div>
              </div>
                ...
                {filiaisDisponiveis.length === 0 ? (
                  ...
                  <div className="checkbox-grid">
                    {filiaisDisponiveis.map((filial) => (
                      <label key={filial} className="checkbox-item">
                        <input
                          type="checkbox"
